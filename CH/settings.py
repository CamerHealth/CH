...
SECRET_KEY = 'r)ull5h_lt)w7!u_i)vb+tmb_my6yl3xe2ac^9-m!yus@8(-+&'
...
COVERAGE_EXCLUDE_MODULES = ('CH.migrations', 'CH.tests',
                            'CH.local_settings',
